				...
				<form action="<?php echo USCES_CART_URL; ?>" method="post" name="customer_form" onKeyDown="if(event.keyCode == 13){return false;}">
					...
					<table border="0" cellpadding="0" cellspacing="0" class="customer_form">
						...
						<tr>
							...
							<td colspan="2"><input name="customer[password1]" style="width:100px" type="password" value="<?php esc_attr_e($usces_entries['customer']['password1']); ?>" autocomplete="new-password" /><?php if( $member_regmode != 'editmemberfromcart' ) _e('When you enroll newly, please fill it out.', 'usces'); ?>	<?php wel_password_policy_message(); ?></td>
						</tr>
						<tr>
